...
const Navbar = () => {
  ...
  return (
    <div className="pt-5 px-10 w-full flex justify-center relative z-[999]">
      <header className="w-full max-w-[1750px] bg-white/60 dark:bg-[#0a0a0a]/30 backdrop-blur-xl border border-white/50 dark:border-white/5 rounded-sm p-4 shadow-xl dark:shadow-2xl relative">
        <div className="flex items-center justify-between px-2">
          ...
          >
            ...
            <div className="flex flex-col border-r border-white/50 dark:border-white/10 pr-8">
              <h1 className="text-slate-800 dark:text-white text-[28px] font-bold tracking-[0.1em] uppercase leading-none transition-colors group-hover:text-red-600 dark:group-hover:text-red-500">
          ...
          {/* مؤشر الـ Online */}
          <div className="flex items-center gap-2.5 bg-white/40 dark:bg-black/40 px-4 py-1.5 border border-green-500/20 rounded-full">
          ...
          <div className="flex items-center gap-4 pl-8 border-l border-white/50 dark:border-white/10">
            {/* Theme Toggle */}
            <button
              onClick={toggleTheme}
            ...
            <div className="text-right leading-tight">
              ...
              <p className="text-slate-800 dark:text-white text-sm font-bold tracking-wider capitalize">
                {userName}
              </p>
              <p className="text-slate-500 text-[10px] uppercase font-black tracking-tighter opacity-70">
                Traffic Authority
              </p>
            </div>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-4 w-52 bg-white/80 backdrop-blur-3xl dark:bg-[#0c0c0c] border border-white/50 dark:border-white/10 rounded-2xl shadow-xl dark:shadow-[0_20px_50px_rgba(0,0,0,0.9)] py-2 z-[1000] animate-in fade-in zoom-in duration-200 ring-1 ring-black/5 dark:ring-white/5">
                  <div className="px-4 py-3 border-b border-white/50 dark:border-white/5 mb-1 bg-white/40 dark:bg-white/[0.02]">
                    <p className="text-[9px] text-slate-500 font-black uppercase tracking-[0.2em]">
                      Session Control
                    </p>
                    <p className="text-slate-800 dark:text-white text-[11px] font-bold mt-1">
                      {userName}
                    </p>
                  </div>
