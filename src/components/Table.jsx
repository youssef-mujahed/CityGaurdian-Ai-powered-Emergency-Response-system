...
const Table = ({ incidents = [], onSelectIncident, activeId, onRefresh }) => {
  ...
  return (
    <div className="p-7 relative overflow-hidden w-full">
      {/* Table Header */}
      <div className="grid grid-cols-7 px-6 mb-5 text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 border-b border-white/5 pb-4">
              ...
              >
                ...
                <div className="text-right flex justify-end gap-2 pr-2">
                  ...
                  <button 
                    ...
                    className="p-2.5 bg-white/5 rounded-xl border border-white/10 hover:bg-red-600 hover:border-red-500 transition-all text-white group"
      ...
      {viewedIncident && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/90 backdrop-blur-md p-4">
          <div className="bg-[#0a0a0a] border border-white/10 rounded-3xl flex flex-col w-full max-w-4xl max-h-[85vh] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            
            {/* Header */}
            <div className="flex-none flex items-center justify-between p-4 sm:px-6 border-b border-white/5 bg-white/[0.02]">
              <div className="flex items-center gap-4">
                <button 
                  onClick={() => setViewedIncident(null)}
                  className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 rounded-xl transition-all text-white border border-white/10 group"
                >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-black text-lg sm:text-xl tracking-widest uppercase leading-tight">
                      Spectator View
                    </h3>
            ...
            {/* Footer Details */}
            <div className="flex-none grid grid-cols-3 divide-x divide-white/5 bg-white/[0.02] border-t border-white/5">
              <div className="p-4 text-center">
                <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1">Type</p>
                <p className="text-xs sm:text-sm text-white font-black uppercase tracking-wider">{viewedIncident.type}</p>
              </div>
              <div className="p-4 text-center">
                <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1">AI Confidence</p>
                <p className="text-xs sm:text-sm text-white font-black uppercase tracking-wider">
