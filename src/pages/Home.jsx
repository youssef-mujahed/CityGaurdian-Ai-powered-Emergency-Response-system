    ...
    <div className="h-screen w-full flex flex-col text-white overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden pt-2 pr-4 gap-2">
        ...
        <div className="hidden md:block h-full pl-4">
          <div className="h-full bg-black/20 backdrop-blur-md border border-white/5 rounded-[2.5rem] overflow-hidden shadow-2xl ml-5">
            <Sidebar />
          </div>
        </div>
        ...
        <main className="flex-1 overflow-y-auto custom-scroll pr-1">
          {loading && incidents.length === 0 ? (
            ...
            <div className="max-w-[1500px] mx-auto space-y-4 pb-10">
              ...
              {/* 2. Tactical Map View */}
              <div className="w-full bg-black/30 backdrop-blur-md rounded-[2.5rem] border border-white/5 overflow-hidden shadow-2xl">
                <Mapsection
                  incidents={incidents}
